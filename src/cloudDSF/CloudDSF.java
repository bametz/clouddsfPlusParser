...
public class CloudDSF extends CloudDSFEntity {
  ...
  /**
   * Sets relation between two decisions by retrieving their id and putting it into
  ...
  /**
   * Adds all relations from the task, decision and outcome list to the relations list.
   */
   ...
   * around and vice versa for decisions
   * 
